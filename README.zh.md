...
最新版本：[v3.6.0](https://github.com/zhitongblog/solomd/releases/latest)。
...
- [`SoloMD_3.6.0_x64-portable.zip`](https://github.com/zhitongblog/solomd/releases/latest/download/SoloMD_3.6.0_x64-portable.zip) — 免安装版
